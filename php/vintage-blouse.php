...
<section class="breadcrumb">
  <div class="breadcrumb__list flex container">
    ...
    <span class="breadcrumb__link"> > </span>
    <span class="breadcrumb__link">Vintage Blouse</span>
  </div>
</section>
...
<section class="section product-detail">
  <div class="details container">
    <div class="left image-container">
      <div class="main">
        <img src="Vintage-Blouse.jpeg" id="zoom" alt="" />
      </div>
    </div>
    <div class="right">
      <span>PRELOVED/Shirts</span>
      <h1>Vintage Blouse</h1>
      <div class="price">RM10.00</div>
      <form>
        <div>
          <select>
            <option value="Select Size" selected>Size: XS</option>
          </select>
        </div>
      </form>
      <form class="form">
