...
<head>
  ...
  <title>Preloved Baju Kurung</title>
</head>
...
<section class="breadcrumb">
  <div class="breadcrumb__list flex container">
    ...
    <span class="breadcrumb__link"> > </span>
    <span class="breadcrumb__link">Preloved Baju Kurung</span>
  </div>
</section>
...
<section class="section product-detail">
  <div class="details container">
    <div class="left image-container">
      <div class="main">
        <img src="preloved-baju-kurung.jpeg" id="zoom" alt="" />
      </div>
    </div>
    <div class="right">
      <span>PRELOVED/Shirts</span>
      <h1>Preloved Baju Kurung</h1>
      <div class="price">RM70.00</div>
      <form>
        <div>
          <select>
            <option value="Select Size" selected>Size: M</option>
          </select>
        </div>
      </form>
      <form class="form">
      ...
      <p>
        - Brand : Lilit x Farm Fresh<br/> <br/>
        - Colour : ream<br/> <br/>
        - Size : S (M can fit also)<br/> <br/>
        - Best for raya!
      </p>
    </div>
  </div>
