...
<head>
  ...
  <title>Puma Future Match Indoor</title>
</head>
...
<section class="breadcrumb">
  <div class="breadcrumb__list flex container">
    ...
    <span class="breadcrumb__link"> > </span>
    <span class="breadcrumb__link">Puma Future Match Indoor</span>
  </div>
</section>
...
<section class="section product-detail">
  <div class="details container">
    <div class="left image-container">
      <div class="main">
        <img src="Puma-Future-Match-Indoor.jpeg" id="zoom" alt="" />
      </div>
    </div>
    <div class="right">
      <span>PRELOVED/Shoes</span>
      <h1>Puma Future Match Indoor</h1>
      <div class="price">RM150.00 (Negotiable)</div>
      <form>
        <div>
          <select>
            <option value="Select Size" selected>Size: 6 UK</option>
          </select>
        </div>
      </form>
      <form class="form">
