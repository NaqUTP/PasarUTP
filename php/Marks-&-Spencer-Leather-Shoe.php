...
<head>
  ...
  <title>Marks & Spencer Leather Shoe</title>
</head>
...
<section class="breadcrumb">
  <div class="breadcrumb__list flex container">
    ...
    <span class="breadcrumb__link"> > </span>
    <span class="breadcrumb__link">Marks & Spencer Leather Shoe</span>
  </div>
</section>
...
<section class="section product-detail">
  <div class="details container">
    <div class="left image-container">
      <div class="main">
        <img src="Marks-&-Spencer-Leather-Shoe.jpeg" id="zoom" alt="" />
      </div>
    </div>
    <div class="right">
      <span>PRELOVED/Shoes</span>
      <h1>Marks & Spencer Leather Shoe</h1>
      <div class="price">RM79.00 (Negotiable)</div>
      <form>
        <div>
          <select>
            <option value="Select Size" selected>Size: 8 UK</option>
          </select>
        </div>
      </form>
      <form class="form">
