...
<head>
  ...
  <title>Romand Glasting Melting Lip</title>
</head>
...
<section class="breadcrumb">
  <div class="breadcrumb__list flex container">
    ...
    <span class="breadcrumb__link"> > </span>
    <span class="breadcrumb__link">Romand Glasting Melting Lip</span>
  </div>
</section>
...
<section class="section product-detail">
  <div class="details container">
    <div class="left image-container">
      <div class="main">
        <img src="romand-glasting-melting-lip.jpeg" id="zoom" alt="" />
      </div>
    </div>
    <div class="right">
      <span>PRELOVED/Makeup</span>
      <h1>Romand Glasting Melting Lip</h1>
      <div class="price">RM30.00</div>
      <form>
        <div>
          <select>
            <option value="Select Size" selected>Color: Lovely Pink</option>
          </select>
        </div>
      </form>
      <form class="form">
