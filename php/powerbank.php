...
<section class="breadcrumb">
  <div class="breadcrumb__list flex container">
    ...
    <span class="breadcrumb__link"> > </span>
    <span class="breadcrumb__link">Powerbank</span>
  </div>
</section>
...
<section class="section product-detail">
  <div class="details container">
    <div class="left image-container">
      <div class="main">
        <img src="powerbank.jpeg" id="zoom" alt="" />
      </div>
    </div>
    <div class="right">
      <span>PRELOVED/Powerbank</span>
      <h1>Powerbank</h1>
      <div class="price">RM150.00</div>
      <form>
        <div>
          <select>
            <option value="Select Size" selected>Capacity: 30,000mAh</option>
          </select>
        </div>
      </form>
      <form class="form">
      ...
      <p>
        - USB-C and Micro USB to charge the Powerbank<br/> <br/>
        - Fast charging<br/> <br/>
        - RTS : Too big for my pockets<br/> <br/>
