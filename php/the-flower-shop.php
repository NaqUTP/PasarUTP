...
<section class="breadcrumb">
  <div class="breadcrumb__list flex container">
    ...
    <span class="breadcrumb__link"> > </span>
    <span class="breadcrumb__link">The Flower Shop</span>
  </div>
</section>
...
<section class="section product-detail">
  <div class="details container">
    <div class="left image-container">
      <div class="main">
        <img src="The-Flower-Shop.jpeg" id="zoom" alt="" />
      </div>
    </div>
    <div class="right">
      <span>PREORDER/Flowers</span>
      <h1>The Flower Shop</h1>
      <div class="price">From RM5.00</div>
      <form>
        <div>
          <select>
            <option value="Select Size" selected>Size: Standard</option>
          </select>
        </div>
      </form>
      <form class="form">
        <input type="text" placeholder="1" readonly/>
        <a href="https://docs.google.com/forms/d/e/1FAIpQLSfL2oe-yfJVFr5xk9MF4WvIH_Q3XVfnXb4JuQKxqwpXcLg8SQ/viewform?usp=sf_link" class="addCart">Order Now!</a>
      </form>
      <h3>Product Detail</h3>
      <p>
        *Indulge in a floral fantasy at Pasar Kabut The Flower Shop's pop-up sale today! 🌺*<br/> <br/>

        From 6pm to midnight, discover a mesmerizing array of blooms at the V7 Parking Area 🤩<br/> <br/>

        Whether you're looking to express love, appreciation, or simply uplift your spirits, our affordable prices starting at just *‼️RM5‼️* a stem make it easy to find the perfect bouquet 💕 <br/> <br/>

        Don't miss this chance to spread joy to yourself and others!<br/> <br/>

        📞*Contact Information*<br/>
        For more inquiries or details, reach out to:<br/>
        Syaza (013-3888607)
      </p>
    </div>
  </div>
