...
<head>
  ...
  <title>Lokelteez JP35 Japanese Premium Kaen Flame</title>
</head>
...
<section class="breadcrumb">
  <div class="breadcrumb__list flex container">
    ...
    <span class="breadcrumb__link"> > </span>
    <span class="breadcrumb__link">Lokelteez JP35 Japanese Premium Kaen Flame </span>
  </div>
</section>
...
<section class="section product-detail">
  <div class="details container">
    <div class="left image-container">
      <div class="main">
        <img src="lokelteez-JP35-Japanese-PREMIUM-KAEN-FLAME.jpeg" id="zoom" alt="" />
      </div>
    </div>
    <div class="right">
      <span>PRELOVED/Shirts</span>
      <h1>Lokelteez JP35 Japanese Premium Kaen Flame</h1>
      <div class="price">RM45.00 (Negotiable)</div>
      <form>
        <div>
          <select>
            <option value="Select Size" selected>Size: 3XL</option>
          </select>
        </div>
      </form>
      <form class="form">
      ...
      <p>
        - Retro collar jersey / 280gsm<br/> <br/>
        - Condition : 9.5/10<br/> <br/>
        - Original price : RM85<br/> <br/>
        - RTS : rarely used
      </p>
    </div>
  </div>
