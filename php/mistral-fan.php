...
<section class="breadcrumb">
  <div class="breadcrumb__list flex container">
    ...
    <span class="breadcrumb__link"> > </span>
    <span class="breadcrumb__link">Mistral Fan</span>
  </div>
</section>
...
<section class="section product-detail">
  <div class="details container">
    <div class="left image-container">
      <div class="main">
        <img src="mistral-fan.jpeg" id="zoom" alt="" />
      </div>
    </div>
    <div class="right">
      <span>PRELOVED/Fan</span>
      <h1>Mistral Fan</h1>
      <div class="price">RM130.00 (Negotiable)</div>
      <form>
        <div>
          <select>
            <option value="Select Size" selected>Size: 10 inch</option>
          </select>
        </div>
      </form>
      <form class="form">
      ...
      <p>
        - Condition 9/10 <br/> <br/>
        - RTS : Haven’t been using it<br/> <br/>
        - Original price: RM365.00 <br/> <br/>
