...
<head>
  ...
  <title>Ipad Air 4th Generation</title>
</head>
...
<section class="breadcrumb">
  <div class="breadcrumb__list flex container">
    ...
    <span class="breadcrumb__link"> > </span>
    <span class="breadcrumb__link">Ipad Air 4th Generation</span>
  </div>
</section>
...
<section class="section product-detail">
  <div class="details container">
    <div class="left image-container">
      <div class="main">
        <img src="Ipad-Air-4th-Generation.jpeg" id="zoom" alt="" />
      </div>
    </div>
    <div class="right">
      <span>PRELOVED/Ipad</span>
      <h1>Ipad Air 4th Generation</h1>
      <div class="price">RM2,800.00</div>
      <form>
        <div>
          <select>
            <option value="Select Size" selected>Storage: 256GB</option>
          </select>
        </div>
      </form>
      <form class="form">
      ...
      <p>
        - Wifi + Cellular (Can insert sim card / esim)<br/> <br/>
        - Colour: Space Grey<br/> <br/>
        - 10.9" Large Screen Display<br/> <br/>
        - Touch ID<br/> <br/>
        - Perfect Condition (No scratch) & Rarely Used<br/> <br/>
        - Apple Pencil 2nd Generation worth RM 599 (Used few times only)<br/> <br/>
        - Original Tempered Glass from Switch worth  RM 139<br/> <br/>
        - Brand New Original Type-C Cable worth RM 99<br/> <br/>
      </p>
    </div>
  </div>
</section>
