...
<section class="breadcrumb">
  <div class="breadcrumb__list flex container">
    ...
    <span class="breadcrumb__link"> > </span>
    <span class="breadcrumb__link">Shawarma Zinger</span>
  </div>
</section>
...
<section class="section product-detail">
  <div class="details container">
    <div class="left image-container">
      <div class="main">
        <img src="shawarma-zinger.jpeg" id="zoom" alt="" />
      </div>
    </div>
    <div class="right">
      <span>Food</span>
      <h1>Shawarma Zinger</h1>
      <div class="price">RM5.00</div>

      <form class="form">
        <a href="https://web.telegram.org/a/#475243879" class="addCart">Order Now</a>
      </form>
      <h3>Product Detail</h3>
      <p>
        Hello everyone 👋🏽<br/>
        This is your daily Shawarma delivery guy<br/> <br/>

        🔥Tasty & Warm Shawarma restock<br/> <br/>

        Rm5 only<br/> <br/>

        Delivery to your room for males<br/>
        and to lobby for females✅<br/> <br/>

        Delivery starts at 6pm<br/> <br/>

        Enjoy your daily delicious snack  🌯 😋<br/> <br/>

        Any enquiries on delivery pls PM
      </p>
    </div>
  </div>
</section>
