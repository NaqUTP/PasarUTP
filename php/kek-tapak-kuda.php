...
<section class="breadcrumb">
  <div class="breadcrumb__list flex container">
    ...
    <span class="breadcrumb__link"> > </span>
    <span class="breadcrumb__link">Kek Tapak Kuda</span>
  </div>
</section>
...
<section class="section product-detail">
  <div class="details container">
    <div class="left image-container">
      <div class="main">
        <img src="kek-tapak-kuda.jpeg" id="zoom" alt="" />
      </div>
    </div>
    <div class="right">
      <span>Food/Cakes</span>
      <h1>Kek Tapak Kuda</h1>
      <div class="price">RM26.00</div>

      <form class="form">
        <a href="//forms.gle/ZtZwnX3X2n8tZebw7" class="addCart">Order Now</a>
      </form>
      <h3>Product Detail</h3>
      <p>
        - Nutella Crunchy 🍫 <br/> <br/>
        - Nutella Matcha Crunchy 🍵<br/> <br/>
        - Nutella Hokkaido Crunchy (white chocolate + nutella)<br/> <br/>
        - Nutella Strawberry Crunchy 🍓<br/> <br/>
        - Size : 10 inch <br/> <br/>
        - Pickup Venue : Available at V1C<br/> <br/>
        - Delivery : RM 1.00 [V1 & V2] || RM 2.00 [V3, V4, V5, V6]
      </p>
    </div>
  </div>
</section>
