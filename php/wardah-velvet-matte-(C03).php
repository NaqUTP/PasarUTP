...
<head>
  ...
  <title>Wardah Velvet Matte (C03)</title>
</head>
...
<section class="breadcrumb">
  <div class="breadcrumb__list flex container">
    ...
    <span class="breadcrumb__link"> > </span>
    <span class="breadcrumb__link">Wardah Velvet Matte (C03)</span>
  </div>
</section>
...
<section class="section product-detail">
  <div class="details container">
    <div class="left image-container">
      <div class="main">
        <img src="wardah-velvet-matte-(C03).jpeg" id="zoom" alt="" />
      </div>
    </div>
    <div class="right">
      <span>PRELOVED/Makeup</span>
      <h1>Wardah Velvet Matte (C03)</h1>
      <div class="price">RM16.00</div>
      <form>
        <div>
          <select>
            <option value="Select Size" selected>Color: Velvet Matte</option>
          </select>
        </div>
      </form>
      <form class="form">
      ...
      <p>
        - NP : RM23.92<br/> <br/>
        - Baru buka packaging dia<br/> <br/>
        - RTS : Salah code color
      </p>
    </div>
  </div>
</section>
