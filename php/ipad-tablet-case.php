...
<section class="breadcrumb">
  <div class="breadcrumb__list flex container">
    ...
    <span class="breadcrumb__link"> > </span>
    <span class="breadcrumb__link">Ipad/Tablet Case</span>
  </div>
</section>
...
<section class="section product-detail">
  <div class="details container">
    <div class="left image-container">
      <div class="main">
        <img src="IPAD-TABLET-CASE.jpeg" id="zoom" alt="" />
      </div>
    </div>
    <div class="right">
      <span>PRELOVED/Casing</span>
      <h1>Ipad/Tablet Case</h1>
      <div class="price">RM15.00</div>
      <form>
        <div>
          <select>
            <option value="Select Size" selected>Size: 10.9 INCH</option>
          </select>
        </div>
      </form>
      <form class="form">
