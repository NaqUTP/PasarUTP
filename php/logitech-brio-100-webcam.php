...
<section class="breadcrumb">
  <div class="breadcrumb__list flex container">
    ...
    <span class="breadcrumb__link"> > </span>
    <span class="breadcrumb__link">LogiTech Brio 100 Webcam</span>
  </div>
</section>
...
<section class="section product-detail">
  <div class="details container">
    <div class="left image-container">
      <div class="main">
        <img src="logitech-brio-100-webcam.jpeg" id="zoom" alt="" />
      </div>
    </div>
    <div class="right">
      <span>PRELOVED/Camera</span>
      <h1>LogiTech Brio 100 Webcam</h1>
      <div class="price">RM150.00</div>
      <form>
        <div>
          <select>
            <option value="Select Size" selected>Size: Mini</option>
          </select>
        </div>
      </form>
      <form class="form">
      ...
      <p>
        - Full HD 1080p <br/> <br/>
        - Built-in microphone<br/> <br/>
        - RTS : Rarely used<br/> <br/>
        - Condition: 10/10<br/> <br/>
        - Original price : RM179.00
      </p>
    </div>
  </div>
</section>
