...
<section class="breadcrumb">
  <div class="breadcrumb__list flex container">
    ...
    <span class="breadcrumb__link"> > </span>
    <span class="breadcrumb__link">Stylish Shirt</span>
  </div>
</section>
...
<section class="section product-detail">
  <div class="details container">
    <div class="left image-container">
      <div class="main">
        <img src="stylish-shirts.jpeg" id="zoom" alt="" />
      </div>
    </div>
    <div class="right">
      <span>PREORDER/Shirts</span>
      <h1>Stylish Shirt</h1>
      <div class="price">From RM40.00</div>
      <form>
        <div>
          <select>
      ...
      <form class="form">
        ...
        <a href="https://forms.gle/83s9cMFYVuu3S2jC6" class="addCart">Order Now!</a>
      </form>
      <h3>Product Detail</h3>
      <p>
        🎉*Get ready to upgrade your wardrobe!*🎉<br/> <br/>

        *For the next 3 days only*, snag our stylish shirts at a special discounted price of just *RM40*‼️*down from RM48.* Don't miss out on this limited-time offer to elevate your fashion game‼️<br/> <br/>

        📆 Promotion open from *4 - 6 March 2024*❗<br/> <br/>
