...
<section class="breadcrumb">
  <div class="breadcrumb__list flex container">
    ...
    <span class="breadcrumb__link"> > </span>
    <span class="breadcrumb__link">JBL Flip 5</span>
  </div>
</section>
...
<section class="section product-detail">
  <div class="details container">
    <div class="left image-container">
      <div class="main">
        <img src="JBL-flip-5.jpeg" id="zoom" alt="" />
      </div>
    </div>
    <div class="right">
      <span>PRELOVED/Speaker</span>
      <h1>JBL Flip 5</h1>
      <div class="price">RM350.00</div>
      <form>
        <div>
          <select>
            <option value="Select Size" selected>Size: Medium</option>
          </select>
        </div>
      </form>
      <form class="form">
      ...
      <p>
        - Battery durability : 12 hours long<br/> <br/>
        - Wireless and Bluetooth speaker<br/> <br/>
        - RTS : Upgrading <br/> <br/>
        - Original price : RM649.00
      </p>
    </div>
  </div>
</section>
