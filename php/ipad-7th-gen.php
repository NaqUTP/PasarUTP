...
<head>
  ...
  <title>Ipad Air 7th Generation</title>
</head>
...
<section class="breadcrumb">
  <div class="breadcrumb__list flex container">
    ...
    <span class="breadcrumb__link"> > </span>
    <span class="breadcrumb__link">Ipad Air 7th Generation</span>
  </div>
</section>
...
<section class="section product-detail">
  <div class="details container">
    <div class="left image-container">
      <div class="main">
        <img src="ipad-7th-gen.jpeg" id="zoom" alt="" />
      </div>
    </div>
    <div class="right">
      <span>PRELOVED/Ipad</span>
      <h1>Ipad 7th Generation</h1>
      <div class="price">N/A</div>
      <form>
        <div>
          <select>
            <option value="Select Size" selected>Storage: N/A</option>
          </select>
        </div>
      </form>
      <form class="form">
        <input type="text" placeholder="1" readonly/>
        <a href="https://web.telegram.org/a/#951221543" class="addCart">Contact Seller</a>
      </form>
      <h3>Product Detail</h3>
      <p>
        - PM seller for more the details.
      </p>
    </div>
  </div>
</section>
