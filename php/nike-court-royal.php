...
<section class="breadcrumb">
  <div class="breadcrumb__list flex container">
    ...
    <span class="breadcrumb__link"> > </span>
    <span class="breadcrumb__link">Nike Court Royale</span>
  </div>
</section>
...
<section class="section product-detail">
  <div class="details container">
    <div class="left image-container">
      <div class="main">
        <img src="nike-court-royal-1.jpeg" id="zoom" alt="" />
      </div>
    </div>
    <div class="right">
      <span>PRELOVED/Shoes</span>
      <h1>Nike Court Royale</h1>
      <div class="price">RM80.00</div>
      <form>
        <div>
          <select>
            <option value="Select Size" selected>Size: 6.5 UK</option>
          </select>
        </div>
      </form>
      <form class="form">
      ...
      <p>
        - Tapak kasut masih elok <br/> <br/>
        - RTS : Wrong size<br/> <br/>
        - Color : black&white<br/> <br/>
        - Sizing : US 9/ UK 6.5/ EUR 40.5/ CM 26/ BR 39/ CN 260
      </p>
    </div>
  </div>
</section>
