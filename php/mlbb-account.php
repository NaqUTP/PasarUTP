...
<section class="breadcrumb">
  <div class="breadcrumb__list flex container">
    ...
    <span class="breadcrumb__link"> > </span>
    <span class="breadcrumb__link">MLBB Account</span>
  </div>
</section>
...
<section class="section product-detail">
  <div class="details container">
    <div class="left image-container">
      <div class="main">
        <img src="Mlbb-account.jpeg" id="zoom" alt="" />
      </div>
    </div>
    <div class="right">
      <span>PRELOVED/Games</span>
      <h1>MLBB Account</h1>
      <div class="price">RM550.00 (Negotiable)</div>
      <form>
        <div>
          <select>
            <option value="Select Size" selected>Server: Old</option>
          </select>
        </div>
      </form>
      <form class="form">
      ...
      <p>
        - Reason for sale because wanna focus to study and already stopped play for a year now <br/> <br/>

        - Total spend around RM1.2K <br/> <br/>

        - Tittle argus Malaysia <br/> <br/>

        - Starlight fragment : 5480 boleh beli skin starlight terus
      </p>
    </div>
  </div>
</section>
