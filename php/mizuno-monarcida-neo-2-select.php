...
<head>
  ...
  <title>Mizuno Monarcida Neo 2 Select</title>
</head>
...
<section class="breadcrumb">
  <div class="breadcrumb__list flex container">
    ...
    <span class="breadcrumb__link"> > </span>
    <span class="breadcrumb__link">Mizuno Monarcida Neo 2 Select</span>
  </div>
</section>
...
<section class="section product-detail">
  <div class="details container">
    <div class="left image-container">
      <div class="main">
        <img src="mizuno-monarcida-neo-2-select.jpeg" id="zoom" alt="" />
      </div>
    </div>
    <div class="right">
      <span>PRELOVED/Shoes</span>
      <h1>Mizuno Monarcida Neo 2 Select</h1>
      <div class="price">RM290.00 (Negotiable)</div>
      <form>
        <div>
          <select>
            <option value="Select Size" selected>Size: 9 UK</option>
          </select>
        </div>
      </form>
      <form class="form">
      ...
      <p>
        - Condition 8/10<br/> <br/>
        - Bought for rm390<br/> <br/>
        - RTS : Got a new one
      </p>
    </div>
  </div>
